...
// ---------------------------------------------------------------------------
// 15. stale session version (NOT IMPLEMENTED — placeholder)
// ---------------------------------------------------------------------------
test('stale session version returns 409 Conflict (NOT IMPLEMENTED)', () => {
  // The current code does not implement optimistic-locking / version checks on
  // verification_sessions. This test documents the gap.
  // Requires: adding a `version` column to verification_sessions, then
  //           checking it in VerificationDecisionRecorder.recordDecision.
  // TODO: implement version check
  assert.ok(true, 'Placeholder — version check not yet implemented');
});
