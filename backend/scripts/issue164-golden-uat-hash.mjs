 ...
 *
 * The output file is written 0600 and is intended to be deleted as soon as the hash has been applied.
 *
...
async function main() {
  ...
  // Only the one-way hash is persisted, with owner-only permissions.
