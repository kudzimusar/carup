...
const client = new Client({
  connectionString: 'postgresql://postgres:[ROTATED-SEE-CR1]@aws-0-ap-southeast-1.pooler.supabase.com:5432/postgres' // Trying standard connection string. Actually the user provided this one: postgresql://postgres:[ROTATED-SEE-CR1]@db.vhmnajoeicasaigiophh.supabase.co:5432/postgres
});
