...
export const WORKBOOK_SERVICE_SCOPES = Object.freeze([
  'FULL_TRADE',
  'VEHICLE_PROCUREMENT',
  'PARTS_PROCUREMENT',
  'SHIPPING_ONLY',
...
export const WORKBOOK_STATUS_LISTS = Object.freeze({
  ...
  SERVICE_SCOPES: WORKBOOK_SERVICE_SCOPES,
...
export const WORKBOOK_SHEETS = Object.freeze({
  ...
  DIASPORA_IMPORT_ORDERS: Object.freeze({
    ...
    optionalColumns: Object.freeze(['CARUP_IMPORT_ORDER_UUID', 'SERVICE_SCOPE', 'LINKED_VEHICLE_VIN', 'PART_ID', 'VEHICLE_ID', 'ORIGIN_CITY', 'DESTINATION_CITY', 'REQUESTED_MAKE', 'REQUESTED_MODEL', 'REQUESTED_YEAR_MIN', 'REQUESTED_YEAR_MAX', 'BUDGET_AMOUNT', 'AUCTION_LOT_NUMBER', 'CHASSIS_NUMBER', 'VIN', 'VERIFICATION_STATUS', 'PAYMENT_STATUS', 'COMPLIANCE_STATUS', 'CONTAINER_ID', 'SHIPMENT_ID', 'NOTES']),
    statusColumns: Object.freeze({ ORDER_TYPE: 'ORDER_TYPES', SERVICE_SCOPE: 'SERVICE_SCOPES', STATUS: 'IMPORT_ORDER_STATUSES', BUDGET_CURRENCY: 'CURRENCIES', VERIFICATION_STATUS: 'VERIFICATION_STATUSES', PAYMENT_STATUS: 'PAYMENT_STATUSES', COMPLIANCE_STATUS: 'COMPLIANCE_STATUSES' }),
  }),
...
export const WORKBOOK_TEMPLATE_SHEETS = Object.freeze({
  ...
  [WORKBOOK_TEMPLATE_TYPES.SUPPLIER]: Object.freeze(['TRADE_PROFILES', 'IMPORT_QUOTES', 'TRADE_DOCUMENTS']),
  [WORKBOOK_TEMPLATE_TYPES.ENTERPRISE]: Object.freeze(Object.keys(WORKBOOK_SHEETS)),
  [WORKBOOK_TEMPLATE_TYPES.CONTAINER_RESERVATION]: Object.freeze(['CONTAINER_SHIPMENTS', 'CARGO_RESERVATIONS', 'DIASPORA_IMPORT_ORDERS']),
});
