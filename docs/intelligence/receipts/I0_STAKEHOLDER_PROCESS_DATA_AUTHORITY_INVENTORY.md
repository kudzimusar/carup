...
| G6 | **P0 — repo Issue #158** (originally logged here as P2; corrected) | `blockchainService.js` persists `private_key_pem` in the `public_keys` table | `backend/services/blockchain/blockchainService.js` | Outside Intelligence scope; escalated to owner |
