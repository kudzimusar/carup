...
2. [S0 — Vehicle Taxonomy & Seller Contract Foundation](./S0_VEHICLE_TAXONOMY_AND_SELLER_CONTRACT_FOUNDATION.md)
...
**S0 — Vehicle Taxonomy & Seller Contract Foundation: IN PROGRESS**
