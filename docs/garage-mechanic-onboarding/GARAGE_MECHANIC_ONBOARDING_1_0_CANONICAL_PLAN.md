...
**Current authority status:** canonical and **executed**. **GMO-0 … GMO-8 are technically certified PASS, and GMO-8 is PRODUCT OWNER ACCEPTED. Merge remains separately unauthorised.** The technically certified product tree is `5bc3c96eaba410d98478ec2f8208d378029d0b2f`; later documentation-only governance commits do not alter that runtime/schema/harness tree. PR #209 remains Draft and unmerged.
