...
export default defineConfig({
  ...
  testMatch: /(?:3[2-7]-diaspora-staging-browser-.*|38-seller-staging-browser-golden|41-seller-phase-e-staging|42-seller-media-lifecycle-staging|43-operations-serena-staging|45-trade-os-container-demo-staging|46-trade-os-rfq2-staging|47-trade-os-t3-staging)\.spec\.ts/,
  timeout: 90_000,
