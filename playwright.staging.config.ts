...
export default defineConfig({
  ...
  // 42 and 45 are ADDITIVE exact-head gates: widening this pattern does not change the older
  // workflows because each of those workflows still names its own spec explicitly.
  testMatch: /(?:3[2-7]-diaspora-staging-browser-.*|38-seller-staging-browser-golden|41-seller-phase-e-staging|42-seller-media-lifecycle-staging|43-operations-serena-staging|44-o2-p7-staging|45-o2-mobile-owner-uat)\.spec\.ts/,
  timeout: 90_000,
