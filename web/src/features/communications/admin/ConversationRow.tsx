...
// assignment, SLA, and last-activity time. Presentational — the page passes precomputed display
// props, so this stays pure and unit-testable. A raw UUID is never the title (enforced upstream).
...
export function ConversationRow({
  ...
  return (
    <button
      ...
      className={`w-full text-left p-3 border-b hover:bg-gray-50 transition-colors ${selected ? 'bg-orange-50 border-l-2 border-l-orange-500' : ''}`}
    >
